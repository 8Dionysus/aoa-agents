...
| `generated/codex_agents/` | Codex subagent projection from base role profile source objects and projection wiring | `mechanics/codex-projection/parts/subagent-projection/scripts/validate_codex_subagents.py` |
