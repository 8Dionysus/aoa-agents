...
WAVE5_CONTRACTS = (
    ('agent_install_compatibility_v1', 'agent_install_compatibility_v1.json'),
    ('assistant_live_incident_v1', 'assistant_live_incident_v1.json'),
    ('assistant_multi_office_release_result_v1', 'assistant_multi_office_release_result_v1.json'),
    ('assistant_office_incident_v1', 'assistant_office_incident_v1.json'),
    ('assistant_office_install_profile_v1', 'assistant_office_install_profile_v1.json'),
    ('assistant_office_live_contract_v1', 'assistant_office_live_contract_v1.json'),
    ('assistant_office_live_profile_v1', 'assistant_office_live_profile_v1.json'),
    ('assistant_office_pairing_v1', 'assistant_office_pairing_v1.json'),
    ('assistant_office_post_release_watch_v1', 'assistant_office_post_release_watch_v1.json'),
    ('assistant_office_revision_ledger_entry_v1', 'assistant_office_revision_ledger_entry_v1.json'),
    ('assistant_office_service_contract_v1', 'assistant_office_service_contract_v1.json'),
    ('assistant_release_watch_config_v1', 'assistant_release_watch_config_v1.json'),
    ('assistant_service_release_v1', 'assistant_service_release_v1.json'),
    ('assistant_train_release_participant_v1', 'assistant_train_release_participant_v1.json'),
)
