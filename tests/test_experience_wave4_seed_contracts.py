...
WAVE4_CONTRACTS = (
    ('agent_governance_posture', 'agent_governance_posture_v1.json'),
    ('agent_kind_conflict_case', 'agent_kind_conflict_case_v1.json'),
    ('agent_office_charter_change', 'agent_office_charter_change_v1.json'),
    ('agent_release_hold', 'agent_release_hold_v1.json'),
    ('assistant_recharter_request', 'assistant_recharter_request_v1.json'),
    ('agent_authority_claim_v1', 'agent_authority_claim_v1.json'),
    ('assistant_runtime_hold_v1', 'assistant_runtime_hold_v1.json'),
)
