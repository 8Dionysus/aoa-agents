...
| `dispatch-reader/` | generated quest catalog and dispatch posture | `dispatch-reader/README.md`, `dispatch-reader/scripts/generate_questbook_readers.py`, `../../../generated/quest_*.json` |
