...
Moved 3 mechanic-specific Titan configs out of root `config/` and into active
...
Moved 3 Titan validators and 4 focused tests out of root execution districts
