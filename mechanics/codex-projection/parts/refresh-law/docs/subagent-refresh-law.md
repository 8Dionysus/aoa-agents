...
This law complements `mechanics/codex-projection/parts/subagent-projection/docs/subagent-projection.md`. It does not make
...
`agents/profiles/` or wiring config. Use `regenerate` or `reproject` when generated or
