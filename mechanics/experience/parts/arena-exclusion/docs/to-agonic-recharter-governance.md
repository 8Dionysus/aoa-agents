# Assistant To Agonic Recharter Governance

Status: seed v0.8.0  
Repo landing: `aoa-agents`  
Layer: Experience Polis Governance

## Purpose

Explicit recharter path for changing service kind into agonic form.
...
- aoa-agents receives only bounded governance surfaces.
