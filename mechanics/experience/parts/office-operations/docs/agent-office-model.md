...
```text
architect      -> boundary_keeper, tracer
coder          -> executor
evaluator      -> arbiter, judge_candidate
memory-keeper  -> chronicler, witness
reviewer       -> verifier, skeptic
```

## First-class role threshold

An office may become a first-class public profile only after review proves that it carries independent ownership, risk, rights, and failure conditions. Until then, it remains an overlay.
