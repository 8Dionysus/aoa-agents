# First Assistant Office Install

Version: 1.0.0

## Purpose

Defines how an assistant office receives v1.0 live form without hidden self-change.
...
- scar ledger in assistant profile
- unreviewed mandate change
