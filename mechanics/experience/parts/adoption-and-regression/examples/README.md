# Adoption And Regression Examples

Public-safe examples for assistant and agent adoption/regression contracts.

| Example | Contract |
| --- | --- |
| [agent-adoption-participation-record.example.json](agent-adoption-participation-record.example.json) | agent adoption participation |
| [agent-adoption-posture-contract.example.json](agent-adoption-posture-contract.example.json) | agent adoption posture |
| [assistant-adoption-certification-delta.example.json](assistant-adoption-certification-delta.example.json) | certification delta |
| [assistant-adoption-guard.example.json](assistant-adoption-guard.example.json) | adoption guard |
| [assistant-adoption-projection.example.json](assistant-adoption-projection.example.json) | adoption projection |
