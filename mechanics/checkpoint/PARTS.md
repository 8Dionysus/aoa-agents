...
| --- | --- | --- |
| `continuity-lane` | [Self-Agency Continuity Lane](parts/continuity-lane/docs/self-agency-continuity-lane.md) | Active schemas: [parts/continuity-lane/schemas/](parts/continuity-lane/schemas/). Active examples: [parts/continuity-lane/examples/](parts/continuity-lane/examples/). |
