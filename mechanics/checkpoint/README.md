...
| next route | `PARTS.md`, checkpoint examples/schemas, `mechanics/antifragility/`, `mechanics/questbook/` |
| validation | checkpoint examples plus repo validators |

## Agent Layer Owns

- role posture for self-agent checkpoint surfaces
- continuity handoff shape where it remains agent-layer posture
- reviewed closeout role hold language
- checkpoint cohort posture as role coordination
...
Add narrower checkpoint schema/example tests when a touched surface has them.
