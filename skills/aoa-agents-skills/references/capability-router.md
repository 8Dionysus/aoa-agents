...
Source graph hash: `132a273b8d9f59bf7a3f6fd0eba698013490a1d6adf5a5eabedf91cee45cadc1`
Federation: `aoa-agents` specializes `aoa-skills:operations`.

| skill | visibility | use when | do not use when | version | fingerprint |
|---|---|---|---|---|---|
| `aoa-agents-skills` | advertised | The owning routing control plane or current holder presents an agent-tool decision whose responsibility boundary is not yet classified.; The aoa-sdk routing control plane or current holder explicitly presents an agent-tool or delegation decision whose responsibility boundary is not yet classified.; Goal planning, execution, or closeout exposes a duty that may need an independently addressable responsibility bearer.; An existing persistent role may need rebinding, return filtering, or controlled wake. | No agent-tool decision, delegation pressure, or independent-duty pressure exists. | 0.5.0 | `5ab1dcd549b49999` |
