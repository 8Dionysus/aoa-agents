...
- Decision ID: AOA-AG-D-0055
- Original date: 2026-05-26
- Surface classes: codex projection, role specialization, schema/contract
- Agent facets: codex projection, role specialization
- Mechanic parents: codex-projection
- Guard families: projection guard, specialization boundary, schema validation
- Posture: accepted
