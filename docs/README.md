...
- Read [AGENT_SUBJECT_PREP](AGENT_SUBJECT_PREP.md) for the bounded future-prep note on subject-bearing agent surfaces.
...
- [AGENT_SUBJECT_PREP](AGENT_SUBJECT_PREP.md) — what future subject-bearing agent preparation may and may not move into the agent layer
