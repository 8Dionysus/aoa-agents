# ASSISTANT PATTERN ADOPTION RUNBOOK

Version: v0.7
Owner surface: `aoa-agents`
Seed family: Experience Adoption Forge

## Purpose

Assistant adoption through release, not hidden self-rewrite.
...
- Assistants adopt through release; agonic agents adopt through trial.
...
- assistant_pattern_adoption_runbook
