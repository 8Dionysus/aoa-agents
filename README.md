...
- example and bounded smoke surfaces: `mechanics/runtime-seam/parts/artifact-contracts/examples/*`, `examples/self_agent_checkpoint/*`, `mechanics/checkpoint/parts/reference-routes/docs/reference-route-examples.md`, and `mechanics/runtime-seam/parts/transition-discipline/docs/runtime-artifact-transitions.md`
